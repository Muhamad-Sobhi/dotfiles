...
static uint32_t colors[][3] = {
    /*               fg          bg          border    */
    [SchemeNorm] = { 0xabb2bfff, 0x282c34ff, 0x3e4452ff },
    [SchemeSel]  = { 0x282c34ff, 0x61afefff, 0x61afefff },
...
static const char *powermenucmd[] = { "/home/mu/.local/bin/powermenu.sh", NULL };
static const char *roficmd[] = { "rofi", "-show", "drun", "-theme", "/home/mu/.config/rofi/launchers/type-2/style-4.rasi", NULL };
...
static const Key keys[] = {
  ...
  { MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_p,           spawn,            SHCMD( "notify-send 'MPV' 'Playing from clipboard...' && " "mpv --ytdl-format='bestvideo[height<=720]+bestaudio/best[height<=720]' " "\"$(wl-paste)\"")},
  { 0,                         XKB_KEY_Print,       spawn,            SHCMD("~/.local/bin/screenshot-full.sh") },
  { WLR_MODIFIER_SHIFT,        XKB_KEY_Print,       spawn,            SHCMD("~/.local/bin/screenshot-area.sh") },
...
//{ MODKEY,                    XKB_KEY_grave,      focusortogglematchingscratch, {.v = scratchpadcmd } },
  { MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_BackSpace,   spawn,            {.v = powermenucmd} },
  { MODKEY,                    XKB_KEY_a,           spawn,            {.v = roficmd} },
