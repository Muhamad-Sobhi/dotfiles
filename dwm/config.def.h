...
static const char *fonts[]          = { "monospace:size=10", "Hack Nerd Font Mono:size=16", "NotoColorEmoji:pixelsize=14:antialias=true:autohint=true","JetBrainsMono Nerd Font:size=11"  };
...
static const Rule rules[] = {
  ...
  { "AlacrittyFloat",  NULL,        NULL,           0,         1,           1,           0,          0,         -1,      50,50,800,500,   5},
  { "St",              NULL,        NULL,           0,         0,           0,           1,          0,         -1,      50,50,500,500,   5},
  { "fzfmenu",         NULL,        NULL,           0,         1,           1,           1,          1,         -1,      50,50,500,500,   5},
  { "amberol",         NULL,        NULL,           1 << 8,    0,           1,           0,          0,         -1,      390,162,500,700, 5},
  { NULL,              NULL,        "Event Tester", 0,         0,           0,           0,          1,         -1,      50,50,500,500,   5},
...
static const char *floattermcmd[] = { "alacritty", "--class", "AlacrittyFloat,AlacrittyFloat", "-o", "window.dimensions.columns=80", "-o", "window.dimensions.lines=25"};
/* command for rofi launcher */
...
static const Key keys[] = {
  ...
  { Mod1Mask,                     XK_z,      spawn,          {.v = floattermcmd } },
